...
from run_inference_sim import demo,centroid_grasp
...
class GraspDetector():
  ...
  def __init__(self):
    ...
    self.grasp_pub = rospy.Publisher('grasp_msg', grasp, queue_size=20)
    ...
    self.cameraInfoSub = rospy.Subscriber('/camera/depth/camera_info', CameraInfo,self.get_cam_info)
  ...
  def inference(self,color,depth):
    ...
    # mask= [300,600,600,1050] #[x1,y1,x2,y2] in image frame

    mask= [700,300,1000,600] #[x1,y1,x2,y2] in image frame for unrotated axes
